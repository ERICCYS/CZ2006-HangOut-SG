...
public class EditCustomerProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: Now the change password part is removed, I think we need to add another change password page.
...
//                password = passwordEt.getText().toString();
                // TODO: Add aditional page for change password, which require the original password. Backend also need to change
                password = "";
